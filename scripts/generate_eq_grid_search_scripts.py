...
# define constants #
HIGH_MEMORY = True  # whether to use high-memory (HM) mode
...
def build_arguments_string(
    ...
    final_line += f" tags=['gcpnet', 'ar', 'grid_search'] logger=wandb logger.wandb.id={run_id} logger.wandb.name={run_name}_GCPv{run['gcp_version']}"
